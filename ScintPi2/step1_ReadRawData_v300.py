...
for daystring in daylist:
	raw_data_files=[]
	raw_data_files = glob.glob("%s/scintpi2_%s_*.dat"%(datafolder,daystring))
	underscores=3
	...
	sat_fields=['SNR1','ELEV','TIME','AZIT']#'PSE1','PSE2'
	...
	h5filename = h5filename.replace('scintpi2_','sc2_lvl0_')
